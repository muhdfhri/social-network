...
Route::middleware(['auth', 'verified', 'VerifiedUser'])->group(function () {
    ...
    Route::prefix('admin/manage')->name('admin.')->group(function () {
        Route::get('/', [\App\Http\Controllers\AdminPostController::class, 'index'])->name('manage');
        Route::delete('/posts/{id}', [\App\Http\Controllers\AdminPostController::class, 'deletePost'])->name('manage.posts.delete');
        Route::delete('/groups/{id}', [\App\Http\Controllers\AdminPostController::class, 'deleteGroup'])->name('groups.delete');
        Route::delete('/channels/{id}', [\App\Http\Controllers\AdminPostController::class, 'deleteChannel'])->name('channels.delete');
    });
    ...
    Route::get('/admin/posts', [\App\Http\Controllers\AdminPostController::class, 'index'])->name('admin.posts');
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('chatify')->group(function() {
        ...
        // Tambahkan route Chatify lainnya di sini jika diperlukan
    });
