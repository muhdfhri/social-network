...
<aside class="z-20 hidden w-64 overflow-y-auto bg-gray-100 dark:bg-gray-800 md:block flex-shrink-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <span class="px-3 my-3 font-bold text-xs text-black dark:text-gray-100">Grup</span>
        <ul>
            <li class="relative px-6 py-1">
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <span class="ml-4">Grup Publik</span>
                    @if ($postType == 'squads')
                        <span class="absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg"
                            aria-hidden="true"></span>
                    @endif
            ...
            <li class="relative px-6 py-1"\>
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <span class="ml-4">Grup Saya</span>
            ...
            <li class="relative px-6 py-1">
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <span class="ml-4">Buat Grup Baru</span>
        ...
        <!-- <hr class="my-3 dark:border-gray-600" /> -->
        <span class="px-3 my-3 font-bold text-xs text-black dark:text-gray-100">Saluran</span>
        <ul>
            <li class="relative px-6 py-1">
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    href="{{ route('channels') }}">
                    ...
                    <span class="ml-4">Saluran Publik</span>
            ...
            <li class="relative px-6 py-1" id="my_squad.html">
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <span class="ml-4">Saluran Saya</span>
            ...
            <li class="relative px-6 py-1" id="new_squad.html">
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <span class="ml-4">Buat Saluran Baru</span>
        ...
        <!-- <hr class="my-3 dark:border-gray-600" /> -->
        <span class="px-3 my-6 font-bold text-xs text-black dark:text-gray-100">Komunikasi</span>
        <ul>
            ...
            <li class="relative px-6 py-1" id="notifications.html">
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <span class="mx-4">Notifikasi</span>
        ...
        <!-- <hr class="my-3 dark:border-gray-600" /> -->
        <span class="px-3 my-6 font-bold text-xs text-black dark:text-gray-100">Pengaturan</span>
        <ul>
            <li class="relative px-6 py-1">
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
            ...
            <li class="relative px-6 py-1">
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <span class="ml-4">Postingan Tersimpan</span>
