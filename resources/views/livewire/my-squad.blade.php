            ...
            @else
                <div class="flex flex-col items-center justify-center h-144">
                    ...
                    <div class="text-center mt-6">
                        <h1 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Tidak Ada Group yang Ditemukan!</h1>
                        <p class="text-gray-500 dark:text-gray-300 mt-2">Tidak ada group yang Anda ikuti. Silakan periksa kembali nanti.</p>
                    </div>
                </div>
            @endif
        </div>
        ...
        <div class="mt-4 p-4 rounded-lg bg-gray-100 shadow-md dark:bg-gray-700">
            ...
            @else
                <div class="flex flex-col items-center justify-center h-144">
                    ...
                    <div class="text-center mt-6">
                        <h1 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Tidak Ada Group yang Ditemukan!</h1>
                        <p class="text-gray-500 dark:text-gray-300 mt-2">Tidak ada group yang Anda buat. Silakan periksa kembali nanti.</p>
                    </div>
                </div>
            @endif
        </div>
