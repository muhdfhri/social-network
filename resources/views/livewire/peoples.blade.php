    ...
    <div class="m-4 p-4 rounded-lg bg-gray-100 shadow-md dark:bg-gray-700">
        ...
        <div class="friends_section ">
            <div class="flex items-center justify-between ">
                <h2 class="text-xl font-bold text-gray-700 dark:text-gray-100">Teman</h2>
            </div>
            @if ($friends->isEmpty() && $get_friends->isEmpty())
                <div class="flex items-center justify-center">
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-100">Tidak ada Teman</p>
                </div>
            @else
        ...
        <div class="hidden request_section">
            <div class="flex items-center justify-between ">
                <h2 class="text-xl font-bold text-gray-700 dark:text-gray-100">Permintaan Pertemanan</h2>
            </div>
            @if ($get_request->isEmpty())
                <div class="flex items-center justify-center">
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-100">Tidak ada Permintaan Pertemanan</p>
                </div>
            @else
                <div class="mt-4 grid gap-6 my-8 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
        ...
        <div class="hidden suggestions_section">
            <div class="flex items-center justify-between ">
                <h2 class="text-xl font-bold text-gray-700 dark:text-gray-100">Saran Teman</h2>
            </div>
            @if ($suggestions->isEmpty())
                <div class="flex items-center justify-center">
                    <p class="text-xl font-bold text-gray-700 dark:text-gray-100">Tidak ada Saran Teman</p>
                </div>
            @else
                <div class="mt-4 grid gap-6 my-8 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
