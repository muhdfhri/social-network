...
<div class="container px-6 mx-auto grid">
    <div class="my-4 flex justify-evenly">
        <a href="{{ route('channels') }}" class="inline-block">
            <button
            ...
            @else
                <div class="flex flex-col items-center justify-center h-144">
                    ...
                    <div class="text-center mt-6">
                        <h1 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Tidak ada saluran!</h1>
                        <p class="text-gray-500 dark:text-gray-300 mt-2">Tidak ada saluran yang Anda ikuti. Silahkan
                            cek kembali nanti.</p>
                    </div>
                </div>
            @endif
