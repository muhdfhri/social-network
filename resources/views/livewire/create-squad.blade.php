...
<div class="flex flex-col items-center">
    <div class="w-3/4 max-w-md bg-gray-100 rounded-lg shadow-xs dark:bg-gray-800 p-6 mt-2">
        <h2 class="mb-2 text-center text-2xl font-bold text-gray-700 dark:text-gray-200">Buat Group Anda Sendiri</h2>
        <form class="flex flex-col" method="post" action="{{ route('create-squad') }}" enctype="multipart/form-data">
            ...
            <button class="bg-blue-500 text-white font-bold py-2 px-4 rounded-md mt-4" type="submit">Buat
                Group</button>
        </form>
    </div>
</div>
