        ...
        <form class="flex flex-col" method="post" action="{{ route('profile.edit') }}" enctype="multipart/form-data">
            ...
            <div class="flex items-center justify-between w-full mb-4 gap-6">
                <label for="dropzone-file"
                    ...
                    <div class="img_view flex flex-col items-center justify-center pt-5 pb-6 h-64 w-full"
                        @if($user->profile)
                            style="background-image: url('{{ asset('storage/' . $user->profile) }}'); background-size: cover; background-repeat: no-repeat; background-position: center"
                        @else
                        ...
                        @if(!$user->profile)
                            ...
                            <p class="mb-2 text-sm text-gray-500 dark:text-gray-400"><span class="font-semibold">Click to upload background</span></p>
                        @endif
                    </div>
                ...
                <label for="dropzone-thumbnail"
                    ...
                    <div class="thumbnail_view flex flex-col items-center justify-center pt-5 pb-6 h-64 w-full"
                        @if($user->thumbnail)
                            style="background-image: url('{{ asset('storage/' . $user->thumbnail) }}'); background-size: cover; background-repeat: no-repeat; background-position: center"
                        @else
                            style="background-color: #f3f4f6;"
                        @endif>
            ...
            <div class="flex justify-between gap-6">
                <label class="w-full text-sm mt-2">
                    <span class="text-gray-700 dark:text-gray-400 font-medium mb-1 block">NIM</span>
                    <div class="relative text-gray-500">
                        <input type="text" name="nim" id="nim" value="{{ $user->nim }}"
                            class="block w-full pl-10 pr-3 py-2 text-sm text-gray-600 dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 border border-gray-300 rounded-md form-input cursor-not-allowed bg-gray-100 dark:bg-gray-800"
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">NIM tidak dapat diubah</p>
                </label>
                ...
                <label class="w-full text-sm mt-2">
                    <div class="relative text-gray-500 focus-within:text-purple-600">
                        <select name="relationship" id="relationship"
                            ...
                            <option value="relationship" @if ($user->relationship == 'relationship') selected @endif>Mempunyai Pasangan
                            </option>
                            <option value="married" @if ($user->relationship == 'married') selected @endif>Menikah</option>
                        </select>
                        <div class="absolute inset-y-0 flex items-center ml-3 pointer-events-none" id="title-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <label class="w-full text-sm mt-2">
                    <div class="relative text-gray-500 focus-within:text-purple-600">
                        <input type="text" name="partner" id="partner" value="{{ $user->partner }}"
                            class="block w-full pl-10 mt-1 text-sm text-black dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"
                            placeholder="Nama Teman Anda" onblur="checkuser()" />
                    ...
                    <div
                        ...
                        <div class="flex justify-evenly">
                            <div class="flex items bg-transparent items-center">
                                ...
                                <label for="male" class="pl-2">Laki - Laki</label>
                            </div>
                            <div class="flex items bg-transparent items-center">
                                <input type="radio" name="gender" id="female" value="female"
                                    @if ($user->gender == 'female') checked @endif class="form-radio">
                                <label for="female" class="pl-2">Perempuan</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-6 mb-4">
                <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-4">Ganti Password</h3>
                <div class="space-y-4">
                    <div class="relative text-gray-500 focus-within:text-purple-600">
