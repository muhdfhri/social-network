...
<div class="container px-6 mx-auto grid">
    ...
    <div class="flex justify-between items-center mt-4">
        <h1 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Notifikasi</h1>
        <div class="flex items-center justify-center gap-6">
            <button
                ...
                Belum Terbaca @if (count($notReadNotifications) > 0)
        ...
        <a href="{{ route('mark-all-as-read') }}" class="text-sm text-blue-500 dark:text-blue-300 hover:underline">Baca
            Semua Notifikasi</a>
    </div>
                ...
                @forelse ($notReadNotifications as $notification)
                    ...
                    @if ($notificationFrom !== null)
                        <div
                            ...
                            <a href="{{ route('mark-as-read', $notification->id) }}">Baca</a>
                        </div>
                    @endif
                @empty
                    <div class="flex flex-col items-center justify-center h-144">
                        ...
                        <div class="text-center mt-6">
                            <h1 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Tidak Ada Notifikasi yang Ditemukan!
                            </h1>
                            <p class="text-gray-500 dark:text-gray-300 mt-2">Tidak ada notifikasi. Silakan periksa kembali
                            nanti.
                            </p>
                        </div>
                    </div>
